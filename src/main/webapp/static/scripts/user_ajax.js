...
function showUsersView(desgnId){
    ajaxFunction();
    if(!(desgnId == "")){
         var contextPath = document.getElementById("context_path").innerHTML;
        ...
        var url = contextPath + "/user/find?page=view&desgnId=" + desgnId;
        ajaxRequest.open("GET",url,true);
        ajaxRequest.send();
    }
}
function showUsersUpdate(desgnId){
    ajaxFunction();
    if(!(desgnId == "")){
       var contextPath = document.getElementById("context_path").innerHTML;
        ajaxRequest.onreadystatechange = function(){
        ...
        var url =  contextPath +  "/user/find?page=update&desgnId=" + desgnId;
        ajaxRequest.open("GET",url,true);
        ajaxRequest.send();
    }
}
...
function showUsersRemove(desgnId){
    ...
    if(!(desgnId == "")){
        ...
        var url =  contextPath +  "/user/find?page=remove&desgnId=" + desgnId;
        ajaxRequest.open("GET",url,true);
        ajaxRequest.send();
    }
}
